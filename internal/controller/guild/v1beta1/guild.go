...
// Package v1beta1 reconciles the namespaced (v1beta1, .m. group) Guild
// managed resource, alongside the cluster-scoped v1alpha1 controller in
// internal/controller/guild.
package v1beta1
...
// Setup adds a controller that reconciles namespaced (v1beta1) Guild managed resources.
