...
func (in *GarbageCollectionSpec) DeepCopyInto(out *GarbageCollectionSpec) {
	*out = *in
	if in.PreventDuplicatesOnCreate != nil {
		in, out := &in.PreventDuplicatesOnCreate, &out.PreventDuplicatesOnCreate
		*out = new(bool)
		**out = **in
	}
	...
	if in.DeleteOrphanedResources != nil {
		in, out := &in.DeleteOrphanedResources, &out.DeleteOrphanedResources
		*out = new(bool)
		**out = **in
	}
...
func (in *RateLimitStatus) DeepCopyInto(out *RateLimitStatus) {
	*out = *in
	if in.ResetAfter != nil {
		in, out := &in.ResetAfter, &out.ResetAfter
		*out = (*in).DeepCopy()
	}
}
