...
[![CI](https://img.shields.io/github/actions/workflow/status/rossigee/provider-discord/ci.yml?branch=master)][build]
[![Version](https://img.shields.io/github/v/release/rossigee/provider-discord)][releases]
...
An enterprise-grade Crossplane provider for managing Discord resources through Kubernetes APIs.
...
provider-discord is under the Apache 2.0 license.
